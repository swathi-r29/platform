  ...
  const getFilteredWorkers = () => {
    ...
    if (filterStatus !== 'all') {
      filtered = filtered.filter(worker => 
        filterStatus === 'available' ? worker.isAvailable : !worker.isAvailable
      );
    }
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => { setFilterStatus('available'); setCurrentIndex(0); }}
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                ...
                <button
                  onClick={() => { setFilterStatus('unavailable'); setCurrentIndex(0); }}
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
        ...
        <div className="relative">
          ...
          <button
            ...
            className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 z-10 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center transition-all ${
              currentIndex === filteredWorkers.length - 1 
                ? 'opacity-30 cursor-not-allowed' 
                : 'hover:bg-purple-50 hover:shadow-xl hover:scale-110'
            }`}
          >
          ...
          <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-purple-500 to-purple-700 px-8 py-10">
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center text-white font-bold text-2xl border-2 border-white/30">
            ...
            <div className="grid grid-cols-3 gap-4 px-8 py-6 bg-gray-50">
              ...
              <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 ${
                  currentWorker.isAvailable ? 'bg-green-100' : 'bg-red-100'
                }`}>
                ...
                <p className={`text-sm font-bold ${currentWorker.isAvailable ? 'text-green-600' : 'text-red-600'}`}>
                  {currentWorker.isAvailable ? 'Available' : 'Unavailable'}
                </p>
              </div>
